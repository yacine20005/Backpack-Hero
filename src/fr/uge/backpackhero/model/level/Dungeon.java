...
public class Dungeon {
    ...
    private void initializeFloors() {
        ...
        floor1.setRoom(new Position(0, 0), new Room(RoomType.CORRIDOR, null, null, null, 0, 0));

        floor1.setRoom(new Position(1, 0), new Room(RoomType.CORRIDOR, null, null, null, 0, 0));

        List<Enemy> enemy_1 = List.of(Enemy.petitRatLoup(), Enemy.petitRatLoup());
        floor1.setRoom(new Position(2, 0), new Room(RoomType.ENEMY, enemy_1, null, null, 0, 0));

        floor1.setRoom(new Position(2, 1), new Room(RoomType.CORRIDOR, null, null, null, 0, 0));

        List<Item> treasure_1 = List.of(Weapon.woodSword(), Armor.woodenShield());
        floor1.setRoom(new Position(3, 1), new Room(RoomType.TREASURE, null, treasure_1, null, 0, 5));

        floor1.setRoom(new Position(4, 1), new Room(RoomType.CORRIDOR, null, null, null, 0, 0));

        List<Enemy> enemy_2 = List.of(Enemy.petitRatLoup());
        floor1.setRoom(new Position(5, 1), new Room(RoomType.ENEMY, enemy_2, null, null, 0, 0));

        floor1.setRoom(new Position(5, 0), new Room(RoomType.HEALER, null, null, null, 20, 0));

        floor1.setRoom(new Position(5, 2), new Room(RoomType.CORRIDOR, null, null, null, 0, 0));
        ...
        floor1.setRoom(new Position(5, 3), new Room(RoomType.MERCHANT, null, null, merchant_1, 0, 0));

        floor1.setRoom(new Position(6, 2), new Room(RoomType.CORRIDOR, null, null, null, 0, 0));

        List<Enemy> enemy_3 = List.of(Enemy.ratLoup());
        floor1.setRoom(new Position(7, 2), new Room(RoomType.ENEMY, enemy_3, null, null, 0, 0));

        floor1.setRoom(new Position(8, 2), new Room(RoomType.CORRIDOR, null, null, null, 0, 0));

        floor1.setRoom(new Position(8, 1), new Room(RoomType.CORRIDOR, null, null, null, 0, 0));

        floor1.setRoom(new Position(8, 0), new Room(RoomType.TREASURE, null, null, null, 0, 20));

        floor1.setRoom(new Position(9, 2), new Room(RoomType.CORRIDOR, null, null, null, 0, 0));

        floor1.setRoom(new Position(10, 2), new Room(RoomType.EXIT, null, null, null, 0, 0));
